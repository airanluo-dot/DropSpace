...
## v0.3.0-preview.13 delivery slice

- Preserve the Preview.12 Smart Drag/OLE, task-ownership, output-policy, encrypted-share, DPAPI revoke, and release/API synchronization boundaries.
- Unify readable external files and confined app-owned payloads through `IItemContentResolver` so repository-shaped images reach Preview, transforms, Hash/ZIP, export capability, and Quick Action profiles.
