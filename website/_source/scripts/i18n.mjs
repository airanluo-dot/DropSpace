...
Object.assign(zh, {
  'BETA 24 / NATIVE ISLAND': 'BETA 24 / 灵动岛',
  ...
  'Get Beta 24': '下载 Beta 24', 'YOUR DESKTOP, WITHIN REACH': '桌面上的日常，触手可及',
  ...
  'BETA 24 / WIDGETS': 'BETA 24 / 小组件',
  'Small things.': '常用小事，', 'Your arrangement.': '按你的习惯排列。',
  'Eight useful widgets on a 4-row, 8-column grid. Move them where they make sense and choose a smaller size where supported.': '八款实用小组件，放进 4 行 × 8 列的网格。按习惯调整位置，支持的组件还可以切换为更小尺寸。',
  ...
  'BETA 24 / MUSIC': 'BETA 24 / 音乐', 'Stay with': '让音乐，', 'the music.': '一直在身边。',
  ...
  'NetEase lyrics first, with automatic fallback to four other sources when no lyrics are found.': '默认优先使用网易云歌词；没有歌词时，自动尝试其他四个来源。',
  'English mode keeps original lyrics and hides Chinese secondary translations.': '英文模式保留原文歌词，隐藏附加的中文翻译。',
  'Improved Apple Music timing and process audio capture.': '改进 Apple Music 时间同步与进程音频捕获。',
  'Some players, including tested NetEase versions, do not expose a valid playback timeline. Estimated lyrics may be out of sync.': '部分播放器（包括已测试的网易云版本）不提供有效播放时间轴，估算的歌词进度可能不同步。'
});
