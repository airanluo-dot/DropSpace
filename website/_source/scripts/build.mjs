...
const redirectScript = await readFile(path.join(src, "redirect.js"));
const redirectName = `redirect.${hash(redirectScript)}.js`;
await writeFile(path.join(dist, "assets", redirectName), redirectScript);
await writeFile(path.join(dist, "index.html"), `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex"><title>DropSpace</title><link rel="canonical" href="${siteOrigin}/en/"><script defer src="${basePath}assets/${redirectName}"></script></head><body><main><h1>DropSpace</h1><p><a href="${basePath}en/">English</a> · <a href="${basePath}zh-cn/">简体中文</a></p></main></body></html>\n`);
await writeFile(path.join(dist, "index.xhtml"), `<?xml version="1.0" encoding="UTF-8"?><html xmlns="http://www.w3.org/1999/xhtml" lang="en"><head><title>DropSpace</title><meta http-equiv="refresh" content="0;url=${siteOrigin}/en/" /></head><body><p><a href="${siteOrigin}/en/">Open DropSpace</a></p></body></html>\n`);
await mkdir(path.join(dist, "changelog"), { recursive: true });
await writeFile(path.join(dist, "changelog", "index.html"), `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta http-equiv="refresh" content="0;url=${siteOrigin}/en/changelog/"><meta name="robots" content="noindex"><title>DropSpace Changelog</title></head><body><p><a href="${siteOrigin}/en/changelog/">Open the DropSpace changelog</a></p></body></html>\n`);
await writeFile(path.join(dist, "changelog", "index.xhtml"), `<?xml version="1.0" encoding="UTF-8"?><html xmlns="http://www.w3.org/1999/xhtml" lang="en"><head><title>DropSpace Changelog</title><meta http-equiv="refresh" content="0;url=${siteOrigin}/en/changelog/" /></head><body><p><a href="${siteOrigin}/en/changelog/">Open the DropSpace changelog</a></p></body></html>\n`);
