...
- Keep lossy pointer movement separate from reliable press/release/cancel/completion/probe signals. Pointer release enters completion grace, a fresh pointer-down supersedes immediately, and every probe/visual callback is session-gated.
