...
public sealed record FinalizedRemovalResult(int RemovedCount, IReadOnlyList<string> PayloadPaths)
{
    public IReadOnlyList<string> PayloadRelativePaths => PayloadPaths;
}
