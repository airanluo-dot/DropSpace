...
- `App` registers the custom XAML attached property in its constructor before any page is parsed, as required by WinUI; it then initializes the resource-backed localizer before creating the first window.
