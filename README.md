...
The **v0.2.1-preview.2** test release establishes English as the base display language, ships matching Simplified Chinese resources, and applies the chosen resource set across the main window, Dynamic Island, tray, errors, accessibility labels, and update feedback. The default follows the Windows display language (Chinese maps to Simplified Chinese; other languages fall back to English); Settings can explicitly select System default, English, or Simplified Chinese after restart.
