...
The **v0.2.1-preview.3** test release keeps the English/Simplified Chinese foundation from preview.2 and fixes Windows sign-in startup so the main window is never shown or activated while tray, clipboard, Dynamic Island, update checks, and single-instance activation initialize in the background.
