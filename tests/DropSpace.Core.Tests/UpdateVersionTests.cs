...
public sealed class UpdateVersionTests
{
    ...
    [DataRow("0.3.0-beta.25", UpdateChannel.Beta, "0.3.0-beta.24|0.3.0-beta.26|0.2.1", "0.3.0-beta.26")]
    [DataRow("0.3.0-beta.25", UpdateChannel.Stable, "0.3.0-beta.26|0.2.1", null)]
    [DataRow("0.3.0-beta.26", UpdateChannel.Beta, "0.3.0-beta.25|0.3.0-beta.27|0.2.1", "0.3.0-beta.27")]
    [DataRow("0.3.0-beta.27", UpdateChannel.Beta, "0.3.0-beta.26|0.2.1", null)]
